...
public class StructuredBuffer(
    ...
    : Buffer(graphicsDevice, BufferUsage.StructuredBuffer,
...
/// <summary>
/// Represents a typed structured buffer.
/// </summary>
/// <typeparam name="TElement">The type of element data in the buffer.</typeparam>
public class StructuredBuffer<TElement> : StructuredBuffer
    where TElement : unmanaged
{
    ...
    /// <param name="capacity">The capacity of the buffer in elements.</param>
    /// <param name="access">The access of the buffer.</param>
    public StructuredBuffer(GraphicsDevice graphicsDevice, int capacity,
        ResourceAccess access = ResourceAccess.Default)
