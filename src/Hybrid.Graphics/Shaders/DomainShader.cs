...
/// <remarks>
/// The <paramref name="entrypoint"/> will default to <c>DSMain</c> when null.
/// </remarks>
public sealed class DomainShader(GraphicsDevice graphicsDevice,
    string source, string? entrypoint = null)
    : Shader(graphicsDevice, source, entrypoint)
{
    /// <inheritdoc/>
    public override ShaderStage Stage => ShaderStage.Domain;
}
