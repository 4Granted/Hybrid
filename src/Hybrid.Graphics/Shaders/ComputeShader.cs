...
/// <remarks>
/// The <paramref name="entrypoint"/> will default to <c>CSMain</c> when null.
/// </remarks>
public sealed class ComputeShader(GraphicsDevice graphicsDevice,
    string source, string? entrypoint = null)
    : Shader(graphicsDevice, source, entrypoint)
{
    /// <inheritdoc/>
    public override ShaderStage Stage => ShaderStage.Compute;
}
