...
/// <remarks>
/// The <paramref name="entrypoint"/> will default to <c>GSMain</c> when null.
/// </remarks>
public sealed class GeometryShader(GraphicsDevice graphicsDevice,
    string source, string? entrypoint = null)
    : Shader(graphicsDevice, source, entrypoint)
{
    /// <inheritdoc/>
    public override ShaderStage Stage => ShaderStage.Geometry;
}
