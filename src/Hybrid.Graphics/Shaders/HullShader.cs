...
/// <remarks>
/// The <paramref name="entrypoint"/> will default to <c>HSMain</c> when null.
/// </remarks>
public sealed class HullShader(GraphicsDevice graphicsDevice,
    string source, string? entrypoint = null)
    : Shader(graphicsDevice, source, entrypoint)
{
    /// <inheritdoc/>
    public override ShaderStage Stage => ShaderStage.Hull;
}
